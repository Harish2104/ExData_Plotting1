...
png(file="plot4.png")
par(mfrow=c(2,2))
plot(datetime,table6$Global_active_power,type="l", xlab="",ylab="Global Active Power")
plot(datetime,table6$Voltage,type="l", xlab="datetime",ylab="Voltage")
plot(datetime,as.numeric(as.character(table6$Sub_metering_1)),type="l",col="black",ylab="Energy sub metering")
...
plot(datetime,table6$Global_reactive_power,type="l", xlab="datetime", ylab="Global_reactive_power")
dev.off()
